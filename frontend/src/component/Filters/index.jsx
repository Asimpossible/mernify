...
const Index = () => {
    ...
    React.useEffect(() => {
        ...
        searchParams.has("max") && setMaxValue(searchParams.get("max"))
    }, [])
    ...
    const handleClick = (checkbox) => {
        ...
        if (checkbox.checked == false) {
            //Delete the category from query
            ...
            if (searchParams.has(checkbox.name)) {
                //Set new category filter in query
                searchParams.set(checkbox.name, checkbox.value)
            } else {
                //Append new category filter in query
